...
#A did the test and B did not
df['ab_test_group'] = df.fitness_test_date.apply(lambda date: 'B' if date == None else 'A')
...
# % of applicants that purchase a membership
ax = plt.subplot()
...
# % of visitors that purchase a membership
ax = plt.subplot()
